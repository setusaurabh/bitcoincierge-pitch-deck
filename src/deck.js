...
const MAP = {
  ...
  h: 6.371,
  cities: {
    Delhi: { x: 4.408, y: 1.7, labelDir: "right" },
    Ahmedabad: { x: 3.393, y: 2.943, labelDir: "left" },
    Mumbai: { x: 3.607, y: 3.409, labelDir: "left" },
    Goa: { x: 3.726, y: 3.952, labelDir: "left" },
    Hyderabad: { x: 5.101, y: 3.71, labelDir: "right" },
    Bangalore: { x: 4.5, y: 4.192, labelDir: "right" },
...
function slide04_Normies(pres) {
  ...
  s.addText(
    "And for rest of 1.4 billion Indians - Bitcoin is still not a real thing!",
    {
      x: 0.5,
      y: 5.0,
      w: 9,
...
function slide05b_SocialFatigue(pres) {
  ...
  s.addImage({
    path: path.join(PROC, "ai_robot.png"),
    x: 1.2,
    y: 1.5,
    w: 2.8,
    h: 2.8,
  ...
  s.addImage({
    path: path.join(PROC, "bitcoin_smiley.png"),
    x: 6.0,
    y: 1.5,
    w: 2.8,
    h: 2.8,
...
function slide05c_Conferences(pres) {
  ...
  opts.forEach(function (o, i) {
    ...
    s.addShape("rect", {
      ...
      line: { color: C.panelBorder, width: 1 },
    });
    s.addShape("rect", {
      x: ox,
      y: 1.42,
  ...
  var pairs = [
    {
      ...
      logic:
        "Keeper built B4I to demo their custody product to a warm, pre-qualified Bitcoin audience — without paying for ads.",
    },
    {
      ...
      brand: "SwapSo",
      logic:
        "SwapSo's founding team built Bitcoin Bharat so college students could discover and use SwapSo through community first.",
    },
    {
      ...
      brand: "GetBit",
      logic:
        "GetBit created Bitcoinwaale — a Bitcoin education community — so more Indians discover GetBit through learning, not ads.",
    },
  ];
...
function slide09_Cover(pres) {
  ...
  s.addText(
    "IRL Event and Community Management.\nFor Bitcoin brands. In India.",
    {
      x: 0.5,
      y: 2.05,
      w: 8.8,
...
function slide10_Solution(pres) {
  ...
  addHeadline(
    s,
    "IRL event & community management\nas a service — for Bitcoin brands.",
    { y: 0.55, h: 1.18, size: 30 },
  );
...
function slide11_WhyNow(pres) {
  ...
  addHeadline(s, "Two big forces are on our side.", {
    y: 0.55,
    h: 0.82,
    size: 34,
  });
  ...
  var cards = [
    {
      num: "1",
      head: "Bitcoin mentors & community are seeded in major Indian cities",
    ...
    {
      num: "2",
      head: "The pendulum is swinging back offline",
...
function slide12_IndiaMap(pres) {
  ...
  addLabel(
    s,
    "B i t c o i n   m e n t o r s   a n d   c o m m u n i t y   a r e   s e e d e d   i n   m a j o r   c i t i e s",
  );

  // India map (exact original position)
  s.addImage({
    data: IMGS.IMG_INDIA_MAP,
    x: MAP.x,
    y: MAP.y,
    w: MAP.w,
    h: MAP.h,
...
function slide13_AIFatigue(pres) {
  ...
  var onlineItems = [
    ...
    "Crypto ad restrictions",
    "Doomscrolling & fatigue",
    "Low ROAS, high burnout",
  ];
  ...
  s.addText(
    "People want to meet in person. They want to hold the hardware. They want to feel the experience — not scroll past another post about it.",
    {
      x: 5.1,
      y: 4.0,
      w: 4.5,
...
function slide14_MarketTraction(pres) {
  ...
  addHeadline(
    s,
    "India is open to Bitcoin products.\nWe are just getting started.",
    { y: 0.52, h: 1.1, size: 28 },
  );
...
function slide15_GTM(pres) {
  ...
  addHeadline(s, "Warm intro → Proof of work → Expand.", {
    y: 0.52,
    h: 0.82,
    size: 30,
  });
  ...
  var steps = [
    {
      num: "01",
      head: "Warm intro or cold outreach",
      body: "Bitshala refers brands outside open-source mandate. We also do cold outreach to our target list.",
    },
    {
      num: "02",
      head: "Partner for First Pilot",
      body: "Show proof of work from past partners (GetBit, Trezor, Zebpay, Ourpool)",
    },
    {
      num: "03",
      head: "Pilot event",
      body: "Brand sponsors one event — fixed fee only, no risk. We handle everything.",
    },
    {
      num: "04",
      head: "First activation",
      body: "Brand joins a meetup as attendee first, sees the audience and experience.",
    },
    {
      num: "05",
      head: "Retainer & revenue share",
      body: "After proven CPA, brand moves to ongoing IRL strategy with performance fees.",
    },
  ];
...
function slide16_BusinessModel(pres) {
  ...
  addHeadline(s, "We charge brands. Not participants.", {
    y: 0.52,
    h: 0.82,
    size: 30,
  });
  ...
  var blocks = [
    {
      ...
      tagBg: "D6E4EF",
      tagColor: "3A6080",
      head: "Event Execution Fee",
      amount: "₹15,000 – ₹20,000",
      sub: "per event",
      items: [
        "Venue booking & management",
        "Mentor / speaker time",
        "Snacks, logistics, ops",
    ...
    },
    {
      ...
      tagBg: "FAD9C8",
      tagColor: "8A3010",
      head: "Performance / Revenue Share",
      amount: "0.5% – 2%",
      sub: "on attributed sales or activations",
      items: [
        "KYC completions / deposits",
        "Hardware wallet sales",
        "Loan / custody product sign-ups",
        "Referrals through mentor network",
      ],
    },
  ];
...
function slide17_ProofOfWork(pres) {
  ...
  s.addImage({ data: IMGS.IMG_INDIA_MAP, x: 3.4, y: 0.1, w: 6.45, h: 5.9 });
  ...
  function scaledX(origX) {
    return offX + origX * scaleX;
  }
  function scaledY(origY) {
    return offY + origY * scaleY;
  }
  ...
  var cityCoords = {
    ...
    Bangalore: { x: 4.5, y: 4.192 },
    Goa: { x: 3.726, y: 3.952 },
    Hyderabad: { x: 5.101, y: 3.71 },
  ...
  activeCities.forEach(function (city) {
    ...
    // City label
    var labelDir =
      ["Delhi", "Hyderabad", "Bangalore", "Chennai"].indexOf(city) >= 0
        ? "right"
        : "left";
...
function slide_CompanyProfile(pres, company) {
  ...
  s.addText(company.name, {
    x: 1.0, y: 0.3, w: 8.0, h: 0.8,
    fontFace: F.serif, fontSize: 56, italic: true, color: C.onDark,
    align: "center", margin: 0,
  });
  s.addText(company.subtitle || "", {
    x: 1.0, y: 1.1, w: 8.0, h: 0.4,
    fontFace: F.sans, fontSize: 24, color: C.gray500,
    align: "center", margin: 0,
  });

  // Left column image
  if (company.img1) {
    let x1 = 2.5 - (company.img1_w / 2);
    s.addImage({ 
      path: company.img1, 
      x: x1,
      y: 1.7, 
...
async function buildDeck(outputPath) {
  var outFile =
    outputPath ||
    path.join(__dirname, "..", "output", "bitcoincierge_pitch_deck.pptx");
  ...
  const ASSETS = path.join(__dirname, "..", "assets", "website-assets", "images");
  const companies = [
    {
      name: "Getbit",
      subtitle: "Bitcoin-only exchange",
      text1: "Meetups in Bangalore & Delhi",
      text2: "Workshops on buying bitcoin into self-custody for 200+ potential customers",
      img1: path.join(ASSETS, "getbit", "getbit-1.jpeg"), img1_w: 2.8, img1_h: 2.1,
      img2: path.join(ASSETS, "getbit", "getbit-2.jpeg"), img2_w: 2.8, img2_h: 2.1
    },
    {
      name: "Zebpay",
      subtitle: "OG Bitcoin / Crypto exchange",
      text1: "Meetups in Mumbai & Delhi",
      text2: "Hundreds of attendees and 10+ new customer acquisitions",
      img1: path.join(ASSETS, "zebpay", "zebpay-1.jpeg"), img1_w: 2.8, img1_h: 1.89,
      img2: path.join(ASSETS, "zebpay", "zebpay-2.jpeg"), img2_w: 2.8, img2_h: 2.1
    },
    {
      name: "Jetking",
      subtitle: "India’s only Bitcoin-treasury firm",
      text1: "Meetups in Mumbai reached to hundreds of potential investors",
      text2: "Online stream helped spread India’s Bitcoin Treasury story to thousands",
      img1: path.join(ASSETS, "jetking", "jetking-1.jpeg"), img1_w: 2.8, img1_h: 2.1,
      img2: path.join(ASSETS, "jetking", "jetking-2.jpeg"), img2_w: 2.8, img2_h: 2.1
    },
    {
      name: "Ourpool",
      subtitle: "One of the newest mining pool on the block",
      text1: "3 Meetups across Bangalore, Mumbai and Delhi",
      text2: "20+ attendees signed up for paid mining cohort in Bitplebs Summit",
      img1: path.join(ASSETS, "ourpool", "ourpool-1.jpeg"), img1_w: 2.8, img1_h: 2.1,
      img2: path.join(ASSETS, "ourpool", "ourpool-2.jpeg"), img2_w: 2.8, img2_h: 2.1
    },
    {
      name: "Bitasha",
